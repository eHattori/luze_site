...
class CI_Template {
 ...
 /**
    * Dynamically include javascript in the template of folder scripts
    * 
   ...
   function add_script_js($script, $type = 'import', $defer = FALSE)
   {
      $success = TRUE;
      $js = NULL;
      ...
      {
         case 'import':
            $filepath = base_url() .'assets/js/scripts/'. $script;
   ...
   function add_js($script, $type = 'import', $defer = FALSE)
   {
      ...
      {
         case 'import':
            $filepath = base_url() .'assets/js/'. $script;
            $js = '<script type="text/javascript" src="'. $filepath .'"';
            if ($defer)
            {
               $js .= ' defer="defer"';
   ...
   function add_css($style, $type = 'link', $media = FALSE)
   {
      ...
      $this->CI->load->helper('url');
      $filepath = base_url() .'assets/css/'.$style;
